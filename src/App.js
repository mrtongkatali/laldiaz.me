      ...
      <div className="col-md-5 section-header hero">
        ...
        <div className="col-md-7 section-content-wrapper hero">
          <div className="section-content">
            ...
            <p>Currently, 
              I spend most of my time working as a full-time <strong>Software Engineer</strong> at <a href="https://experience.digital/" target="_blank" rel="noreferrer"><strong>Experience Digital</strong></a>. I'm actively shipping features for multiple projects and I solve bunch of interesting problems on a daily basis. 
            </p>
          ...
          <div className="section-content">
            ...
            <ul className="expertise-list">
              <li>
                ...
                { _renderIcon(NginxLightIcon, "Nginx") }
              </li>
              <li>
                <i className="fab fa-python fa-1x"></i>
              ...
              <li>
                { _renderIcon(FlaskLightIcon, "Flask") }
              </li>
              <li>
                { _renderIcon(DjangoLightIcon, "Django") }
              </li>
              <li>
                { _renderIcon(GunicornLightIcon, "Gunicorn") }
              </li>
              <li>
                { _renderIcon(MySqlLightIcon, "MySQL") }
              </li>
              <li>
                { _renderIcon(ElasticLightIcon, "Elasticsearch") }
              </li>
              <li>
                { _renderIcon(OpenAPILightIcon, "Open API") }
              </li>
              <li>
                { _renderIcon(AWSLightIcon, "AWS") }
              </li>
            </ul>
            ...
            <ul className="expertise-list">
              <li>
                <FontAwesomeIcon className="fa-icon" icon={faVuejs} />
                Vue
              </li>
              <li>
              ...
              <li>
              <FontAwesomeIcon className="fa-icon" icon={faNodeJs} />
                NodeJS
              </li>
              <li>
                <FontAwesomeIcon className="fa-icon" icon={faJsSquare} />
                Javascript (ES6+)
              </li>
              <li>
              ...
              <li>
                <FontAwesomeIcon className="fa-icon" icon={faSass} />
                SASS
              </li>
              <li>
                <FontAwesomeIcon className="fa-icon" icon={faBootstrap} />
                Bootstrap
              </li>
            </ul>
          </div>
