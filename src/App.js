    ...
    <>
      <div className="container-fluid px-0 position-relative">
        <div className="row no-gutters">
          ...
          <div className="col-md-7 section-content-wrapper hero">
            <div className="section-content">
              <p>Hi, I'm a Full-Stack Developer based in Manila, PH.</p>
        ...
        <div class="row no-gutters">
          <div class="section-bg-opacity"></div>
          <div class="col-md-5 section-header">
            <div class="section-header-content">
              <h4 class="text-primary text-light">Skills</h4>
            </div>
          </div>
          <div class="col-md-7 section-content-wrapper">
            <div class="section-content">
              <p class="mb-3">{">"} Backend Development</p>
              <ul class="expertise-list">
                <li>
                  <i class="fab fa-python fa-1x"></i>
                  Nginx
                </li>
                <li>
                  <i class="fab fa-python fa-1x"></i>
